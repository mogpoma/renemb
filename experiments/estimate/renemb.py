...
class RenembEvaluator():
    def __init__(
        ...
        **kwargs,
        ...
        self.renemb = RenembFinetuneEstimation(
...
if __name__ == "__main__":
    ...
    for rep in range(n_reps):
        evaluator = RenembEvaluator(
            ...
            sys_name=f"renemb_{rep}",
            experiment_dir="experiments/estimate/",
            results_file=f"experiments/estimate/renemb_{rep}_extended_results.csv",
            skip_processing=False,
            batch_size=1,
            subset=100,
            n_workers=100,
            cuda_device=1,
            weights_path = "weights/renemb_estimate.pth",
        )
        evaluator.evaluate()
