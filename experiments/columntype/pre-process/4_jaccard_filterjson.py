...
pathways = [f"{data_dir}/raw_data/{dataset}/" for dataset in ALL_DATASETS]
...
outpath1 = f'{data_dir}/jsonl_data/test_hard_jaccard_ranking.jsonl'
outpath2 = f'{data_dir}/jsonl_data/train_val_hard_jaccard_ranking.jsonl'
...
with open(f'{data_dir}/jsonl_data/train_val_hard.jsonl', 'r+', encoding='utf8') as f:
...
with open(f'{data_dir}/jsonl_data/test_hard.jsonl', 'r+', encoding='utf8') as f:
    for item in jsonlines.Reader(f):
