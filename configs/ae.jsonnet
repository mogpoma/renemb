...

{
  ...
  model: {
    ...
    load_path: "weights/renemb_rowpair_1.pth",
    save_path : "weights/renemb_ae_"+encoding_dim+".pth",
    dropoout :0.1,
    optimizer_lr :1e-3,
  },
    trainer:{
    ...
    logger:{
     ...
     version: "encdim_"+encoding_dim,
    },
    callbacks: {
    pretrain_loader:{pretrained_path:"weights/renemb_rowpair_1.pth",},
