...
local train_dataset = "overall_augmented";
local dev_dataset = "overall";
local d_model = 768;
...

{
 ...
 vocabulary: {
   ...
   model: {
    ...
    // weights: [0.01, 0.1, 1, 0.5],
//    weights: [1, 1, 1, 1],
    optimizer_lr:1e-5,
    save_path : "weights/renemb_dialect.pth",
  },
    trainer:{
...
//    limit_val_batches :0,
    ...
    callbacks: {
    save_renemb_model:{},
    pretrain_loader:{"pretrained_path":"weights/renemb_ae.pth"},
