...
from embedder.utils import gelu
import os

class RenembPretrainingRowPair(pl.LightningModule):
    ...
    def __init__(self,
        ...
        super(RenembPretrainingRowPair, self).__init__()
    ...
    def load_weights(self, load_path = None):
        ...
        if os.path.isfile(load_path):
            ...
            print("Renemb base model not found in "+load_path)
