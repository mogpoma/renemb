...
class RenembBase(pl.LightningModule):
    ...
    def __init__(self,
        ...
        super(RenembBase, self).__init__()
    ...
    def forward(self, input_tokens, **kwargs) -> Dict[str, torch.Tensor]:
        ...
        :param input_tokens: the row pattern tokens as input to the model - as numeric indices of a vocabulary
